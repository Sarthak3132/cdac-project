...
public class ProblemSubmitListener {
    ...
    public void handle(ProblemExecutionMessage msg) {
        log.info("Received SUBMIT request | sessionId={} testCaseCount={}",
        ...
        for (TestCaseDto testCase : msg.testCases()) {
            ...
            if ("Compilation Error".equals(result.statusDescription())) {
                ...
                break; // no point running remaining hidden test cases after a compile failure
            }
        }
        ...
        log.info("Published SUBMIT result | sessionId={} verdict={} passed={}/{}",
